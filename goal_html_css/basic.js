...
// // incomes.forEach(function printOut (income) {
// //     console.log(income)
// // })

// incomes.forEach((income, index) => {
//     console.log(`Position index ${index}: ,value: ${income} + 1`)
//     // Output:
//     // Position 0: 10
//     // Position 1: 20
//     // Position 2: 30
...
//It takes by one one of the items in the array, and interate thru
 
//For loop
// const incomes = [100, 200, 300];
// for (let i = 0; i < incomes.length; i++) {
//     const result = incomes[i];
//     console.log(result)
// }